...
import {RangeElement} from './ui___range_element';
...
export class VolumeBar extends RangeElement {
  ...
  constructor(parent: HTMLElement, controls: Controls) {
    super(
        parent, controls, ['shaka-volume-bar-container'], ['shaka-volume-bar']);
    this.config_ = this.controls.getConfig();
    this.eventManager.listen(
        this.video, 'volumechange', () => this.onPresentationVolumeChange_());
    this.eventManager.listen(
        this.adManager, AdManagerExports.AD_VOLUME_CHANGED,
        () => this.onAdVolumeChange_());
    this.eventManager.listen(
        this.adManager, AdManagerExports.AD_MUTED,
        () => this.onAdVolumeChange_());
    this.eventManager.listen(
