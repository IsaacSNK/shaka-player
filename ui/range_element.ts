 ...
 * @export
 */ 
export class RangeElement extends Element implements shaka.extern.IUIRangeElement {
  ...
  constructor(parent: HTMLElement, controls: Controls, containerClassNames: string[], barClassNames: string[]) {
    ...
    this.eventManager.listen(this.bar, 'touchmove',  
    (e) => {
      if (this.isChanging_) {
        this.setBarValueForTouch_(e);
        this.onChange();
