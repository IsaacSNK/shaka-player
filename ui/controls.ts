    ...
    implements IDestroyable
  {
    ...
    private addEventListeners_() {
      ...
      this.eventManager_.listen(document, "fullscreenchange", () => {
        if (this.ad_) {
          this.ad_.resize(
            this.localVideo_.offsetWidth,
            this.localVideo_.offsetHeight
          );
        }
      });
    }
    ...
    private static createLocalization_(): Localization {
      ...
      const localization: Localization = new shaka.ui.Localization(
        fallbackLocale
      );
 ...
 * @exportDoc
 */
namespace shaka.ui.ControlsPanel {
