...
namespace shaka.ui {
   ...
   * @export
   */
  export class ResolutionSelection extends shaka.ui.SettingsMenu {
    ...
    private updateResolutionSelection_() {
      ...
      this.abrOnSpan_.textContent = this.localization.resolve(
        shaka.ui.Locales.Ids.AUTO_QUALITY
      );
      ...
      if (abrEnabled) {
        ...
        this.currentSelection.textContent = this.localization.resolve(
          shaka.ui.Locales.Ids.AUTO_QUALITY
        );
      }
...
namespace shaka.ui.ResolutionSelection {
  /**
   * @final
   */
...
shaka.ui.OverflowMenu.registerElement(
  "quality",
  new shaka.ui.ResolutionSelection.Factory()
);
