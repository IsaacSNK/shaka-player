...
import {LanguageUtils} from './ui___language_utils';
...
export class TextSelection extends SettingsMenu {
  ...
  private updateTextLanguages_() {
    ...
    LanguageUtils.updateTracks(
        tracks, this.menu, (track) => this.onTextTrackSelected_(track),
        // Don't mark current text language as chosen unless captions are
        // enabled
        this.player.isTextTrackVisible(), this.currentSelection,
        this.localization, this.controls.getConfig().trackLabelFormat);
