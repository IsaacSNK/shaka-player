...
export class RewindButton extends Element {
  ...
  constructor(parent: HTMLElement, controls: Controls) {
    ...
    this.button_.setAttribute('shaka-status', this.localization.resolve(shaka.ui.Locales.Ids.OFF));
  ...
  private updateAriaLabel_() {
    this.button_.ariaLabel = this.localization.resolve(shaka.ui.Locales.Ids.REWIND);
  }
  ...
  private rewind_() {
    ...
    const newRate = newRateIndex != this.rewindRates_.length ? this.rewindRates_[newRateIndex] : this.rewindRates_[0];
