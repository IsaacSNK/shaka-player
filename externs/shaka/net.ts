 ...
 * @exportDoc
 */
export type RetryParameters = { backoffFactor : number , baseDelay : number , connectionTimeout : number , fuzzFactor : number , maxAttempts : number , stallTimeout : number , timeout : number } ;
 ...
 * @exportDoc
 */
export type Response = { data : ArrayBuffer | ArrayBufferView , fromCache ? : boolean , headers : { [ key: string ]: string } , status ? : number , timeMs ? : number , uri : string } ;
 ...
 * @exportDoc
 */
export type SchemePlugin = (a : string , b : shaka.extern.Request , c : shaka.net.NetworkingEngine.RequestType , d : shaka.extern.ProgressUpdated , e : shaka.extern.HeadersReceived ) => shaka.extern.IAbortableOperation < shaka.extern.Response > ;
 ...
 * @exportDoc
 */
export type ProgressUpdated = (a : number , b : number , c : number ) => any ;
 ...
 */
export type HeadersReceived = (a : { [ key: string ]: string } ) => any ;
 ...
 * @exportDoc
 */
export type RequestFilter = (a : shaka.net.NetworkingEngine.RequestType , b : shaka.extern.Request ) => Promise < any > | void ;
 ...
 * @exportDoc
 */
export type ResponseFilter = (a : shaka.net.NetworkingEngine.RequestType , b : shaka.extern.Response ) => Promise < any > | void ;
