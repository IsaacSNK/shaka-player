 ...
 */
export type ManifestDBV2 = { appMetadata : object | null , drmInfo : DrmInfo | null , duration : number , expiration : number , originalManifestUri : string , periods : shaka.extern.PeriodDBV2 [] , sessionIds : string [] , size : number } ;
 ...
 */
export type PeriodDBV2 = { startTime : number , streams : StreamDBV2 [] } ;
 ...
 */
export type SegmentDBV2 = { dataKey : number , endTime : number , startTime : number } ;
 ...
 */
export type SegmentDataDBV2 = { data : ArrayBuffer } ;