 ...
 */
export type ManifestDBV1 = { appMetadata : object | null , drmInfo : shaka.extern.DrmInfo | null , duration : number , expiration : number , key : number , originalManifestUri : string , periods : shaka.extern.PeriodDBV1 [] , sessionIds : string [] , size : number } ;
 ...
 */
export type PeriodDBV1 = { startTime : number , streams : shaka.extern.StreamDBV1 [] } ;
 ...
 */
export type StreamDBV1 = { codecs : string , contentType : string , encrypted : boolean , frameRate ? : number , height : number | null , id : number , initSegmentUri : string | null , keyId : string | null , kind ? : string , label : string | null , language : string , mimeType : string , presentationTimeOffset : number , primary : boolean , segments : shaka.extern.SegmentDBV1 [] , variantIds : number [] , width : number | null } ;
 ...
 */
export type SegmentDBV1 = { endTime : number , startTime : number , uri : string } ;
 ...
 */
export type SegmentDataDBV1 = { data : ArrayBuffer , key : number } ;