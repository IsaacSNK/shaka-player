...
export class VTTCue {
  ...
  static install() {
    ...
    let replacement: ((p1: number, p2: number, p3: string) => TextTrackCue) | null = null;
  ...
  /**
     ...
     *
     */ 
  private static from3ArgsTextTrackCue_(startTime: number, endTime: number, text: string): TextTrackCue {
  ...
  /**
     ...
     *
     */ 
  private static from6ArgsTextTrackCue_(startTime: number, endTime: number, text: string): TextTrackCue {
...
shaka.polyfill.register(VTTCue.install);
