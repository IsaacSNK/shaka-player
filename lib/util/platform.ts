...
export class Platform {
  ...
  static isWebOS3(): boolean {
    ...
    return Platform.userAgentContains_('Web0S') && Platform.userAgentContains_('Chrome/38.0.2125.122 Safari/537.36');
  }
  ...
  static isApple(): boolean {
    return !!navigator.vendor && navigator.vendor.includes('Apple') && !Platform.isTizen() && !Platform.isEOS() && !Platform.isPS4() && !Platform.isAmazonFireTV();
  }
  ...
  static anyMediaElement(): HTMLMediaElement {
    ...
    Platform.cachedMediaElement_ = (document.getElementsByTagName('video')[0] || document.getElementsByTagName('audio')[0] as HTMLMediaElement);
    if (!Platform.cachedMediaElement_) {
      Platform.cachedMediaElement_ = (document.createElement('video') as HTMLMediaElement);
    }
