...
export class EventManager implements IReleasable {
  ...
  /**
       ...
       */ 
  private bindingMap_: MultiMap<Binding_>;
  ...
  /**
     ...
     * @export
     */ 
  listen(target: EventTarget, type: string, listener: ListenerType, options?: boolean | AddEventListenerOptions) {
    if (!this.bindingMap_) {
      return;
    }
  ...
  /**
     ...
     * @export
     */ 
  listenOnce(target: EventTarget, type: string, listener: ListenerType, options?: boolean | AddEventListenerOptions) {
  ...
  /**
     ...
     * @export
     */ 
  unlisten(target: EventTarget, type: string, listener?: ListenerType) {
    if (!this.bindingMap_) {
      return;
    }
...
type ListenerType = (p1: Event) => any;
 ...
 *
 */ 
export class Binding_ {
  private static supportsObject_: boolean | undefined = undefined;
  ...
  /**
     ...
     *    call preventDefault(), which improves scrolling performance.
     */ 
  constructor(public target: EventTarget, public type: string, listener: ListenerType, options?: boolean | AddEventListenerOptions) {
  ...
  /**
     ...
     *
     */ 
  private static convertOptions_(target: EventTarget, value?: boolean | AddEventListenerOptions): boolean | AddEventListenerOptions {
    if (value == undefined) {
      return false;
    } else {
  ...
  /**
     ...
     *
     */ 
  private static doesSupportObject_(target: EventTarget): boolean {
...
// "false" fallback needed for compiler. 
