...
export class EventManager implements IReleasable {
   ...
   */
  listen(
      target: EventTarget, type: string, listener: ListenerType,
...
export class Binding_ {
   ...
   */
  constructor(
      public target: EventTarget, public type: string, listener: ListenerType,
      options?: boolean|AddEventListenerOptions) {
  ...
  private static convertOptions_(
      target: EventTarget, value?: boolean|AddEventListenerOptions): boolean
