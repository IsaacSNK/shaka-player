...
export class FakeEvent {
  ...
  static fromRealEvent(event: Event): FakeEvent {
    ...
    for (const key in event) {
      Object.defineProperty(fakeEvent, key, {value:event[key], writable:true, enumerable:true});
    }
    return fakeEvent;
  }
    ...
    if (dict) {
      if (dict instanceof Map) {
        ...
        for (const key of dict.keys()) {
          Object.defineProperty(this, key, {value:dict.get(key), writable:true, enumerable:true});
        }
      } else {
        ...
        for (const key in obj) {
          Object.defineProperty(this, key, {value:obj[key], writable:true, enumerable:true});
        }
      }
    }
