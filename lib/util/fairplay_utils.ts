  ...
  export class FairPlayUtils {
    ...
    static initDataTransform(
      ...
      if (typeof contentId == "string") {
        contentIdArray = shaka.util.StringUtils.toUTF16(
          contentId,
          /* littleEndian= */
          true
        );
      ...
      const utf16 = shaka.util.StringUtils.toUTF16(
        sdkUri,
        /* littleEndian= */
        true
      );
      ...
      goog.asserts.assert(
        offset == rebuiltInitData.length,
        "Inconsistent init data length"
      );
