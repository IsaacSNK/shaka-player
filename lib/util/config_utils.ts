...
export class ConfigUtils {
    ...
    for (const k in source) {
      ...
      if (!ignoreKeys && !(k in template)) {
        ...
        if (source[k] === undefined) {
          ...
          if (subTemplate.constructor == Object && source[k] && source[k].constructor == Object) {
            ...
            const subMergeValid = ConfigUtils.mergeConfigObjects(destination[k], source[k], subTemplate, overrides, subPath);
            isValid = isValid && subMergeValid;
          } else {
            if (typeof source[k] != typeof subTemplate || source[k] == null ||  
            ...
            typeof source[k] != 'function' && source[k].constructor != subTemplate.constructor) {
              ...
              if (typeof template[k] == 'function' && template[k].length != source[k].length) {
  ...
  /**
     ...
     * @noinline
     */ 
  static referenceParametersAndReturn(parameters: any[], returnValue: T): T {
