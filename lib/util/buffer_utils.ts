...
export class BufferUtils {
   ...
   */
  static toUint8(
      data: BufferSource, offset: number = 0,
      length: number = Infinity): Uint8Array {
   ...
   */
  static toDataView(
      buffer: BufferSource, offset: number = 0,
      length: number = Infinity): DataView {
  ...
  private static view_(
      data: BufferSource, offset: number, length: number,
      Type: (p1: ArrayBuffer, p2: number, p3: number) => any): T {
