...
export class BufferUtils {
  ...
  static equal(arr1: BufferSource | null, arr2: BufferSource | null): boolean {
    ...
    if (BufferUtils.unsafeGetArrayBuffer_(arr1) == BufferUtils.unsafeGetArrayBuffer_(arr2) && (arr1.byteOffset || 0) == (arr2.byteOffset || 0)) {
      return true;
    }
  ...
  /**
     ...
     * @export
     */ 
  static toUint8(data: BufferSource, offset: number = 0, length: number = Infinity): Uint8Array {
  ...
  /**
     ...
     * @export
     */ 
  static toDataView(buffer: BufferSource, offset: number = 0, length: number = Infinity): DataView {
  ...
  /**
     * @template T
     */ 
  private static view_(data: BufferSource, offset: number, length: number, Type: (p1: ArrayBuffer, p2: number, p3: number) => any): T {
