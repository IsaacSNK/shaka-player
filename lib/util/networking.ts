...
export class Networking {
  ...
  /**
     ...
     *
     */ 
  static createSegmentRequest(uris: string[], start: number | null, end: number | null, retryParameters: shaka.extern.RetryParameters, streamDataCallback?: ((p1: BufferSource) => Promise) | null): shaka.extern.Request {
