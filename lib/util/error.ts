 ...
 * <ul>
 *   <li><a
 * href="https://developer.mozilla.org/en-US/docs/Web/API/MediaError">MediaError</a>
 *   <li><a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Status">HTTP
 * Codes</a> <li><a href="https://hresult.info">Edge/PlayReady errors</a>
 * </ul>
 *
 * @export
 */
...
extern.Error {
   ...
   *
   */
  static createStack: boolean = true;
  ...
  constructor(
      public severity: Severity, public category: Category, public code: Code,
      ...varArgs) {
    this.data = varArgs;
...
export enum Code {
   ...
   */
  HLS_AES_128_INVALID_IV_LENGTH,

  /**
   * AES-128 encryption key length should be 16 bytes.
   */
  HLS_AES_128_INVALID_KEY_LENGTH,
   ...
   */
  CURRENT_DAI_REQUEST_NOT_FINISHED
}
