 ...
 * @export
 */
export class Cue implements shaka.
extern.Cue {
  /**
   * @override
   * @exportInterface
  ...
  constructor(
      public startTime: number, public endTime: number,
    ...
    for (const k in cue1) {
      ...
      if (k == 'startTime' || k == 'endTime' || k == 'payload') {
        ...
        if (k == 'nestedCues') {
          ...
          // otherwise recursing here will unbox the method and cause "this" to
          // be undefined in deeper recursion.
 ...
 * @export
 */
export class CueRegion implements shaka.
extern.CueRegion {
  /**
   * @override
   * @exportInterface
