 ...
 * @export
 */ 
export class SbvTextParser implements shaka.extern.TextParser {
  ...
  parseMedia(data, time) {
    ...
    for (const block of blocklist) {
      ...
      if (start == null || expect == null || end == null) {
        throw new Error(ErrorExports.Severity.CRITICAL, ErrorExports.Category.TEXT, ErrorExports.Code.INVALID_TEXT_CUE, 'Could not parse cue time range in SubViewer');
      }
...
TextEngine.registerParser('text/x-subviewer',  
() => new SbvTextParser());
