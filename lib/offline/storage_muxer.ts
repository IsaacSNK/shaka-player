...
export class StorageMuxer implements IDestroyable {
  ...
  getActive(): StorageCellHandle {
    ...
    throw new Error(
        ...
        ErrorExports.Code.MISSING_STORAGE_CELL,
  ...
  async erase(): Promise {
    ...
    const mechanisms: shaka.extern.StorageMechanism[] =
        Array.from(this.mechanisms_.values());
  ...
  static overrideSupport(map:
                             Map<string, () => shaka.extern.StorageMechanism>) {
    override_ = map;
  }
