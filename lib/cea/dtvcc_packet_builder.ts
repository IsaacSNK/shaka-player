...
export class DtvccPacketBuilder {
  ...
  /**
       ...
       */ 
  private currentPacketBeingBuilt_: Cea708ServiceExports.Cea708Byte[] | null = null;
...
class DtvccPacket {
  ...
  readByte(): Cea708ServiceExports.Cea708Byte {
    if (!this.hasMoreData()) {
      throw new Error(ErrorExports.Severity.CRITICAL, ErrorExports.Category.TEXT, ErrorExports.Code.BUFFER_READ_OUT_OF_BOUNDS);
    }
