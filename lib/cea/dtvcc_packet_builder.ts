...
namespace shaka.cea {
  ...
  export class DtvccPacketBuilder {
     ...
     */
    private currentPacketBeingBuilt_: Cea708Byte[] | null = null;
...
namespace shaka.cea {
  export class DtvccPacket {
     ...
     */
    private packetData_: Cea708Byte[];
...
namespace shaka.cea.DtvccPacketBuilder {
