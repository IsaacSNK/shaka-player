...
namespace shaka.cea {
  ...
  export class Cea608Memory {
     ...
     */
    forceEmit(startTime: number, endTime: number): ClosedCaption | null {
    ...
    addChar(set: CharSet, b: number) {
      ...
      switch (set) {
        ...
        case shaka.cea.Cea608Memory.CharSet.SPANISH_FRENCH:
          ...
          this.eraseChar();
          char = shaka.cea.Cea608Memory.CharSet.ExtendedSpanishFrench.get(b);
          break;
        case shaka.cea.Cea608Memory.CharSet.PORTUGUESE_GERMAN:
          this.eraseChar();
          char = shaka.cea.Cea608Memory.CharSet.ExtendedPortugueseGerman.get(b);
          break;
      }
      if (char) {
...
namespace shaka.cea.Cea608Memory {
  /**
