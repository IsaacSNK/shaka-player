  ...
  export class Mp4CeaParser implements ICeaParser {
    ...
    init(initSegment) {
      ...
      new Mp4Parser()
        ...
        .fullBox("trex", (box) => {
          const parsedTREXBox = shaka.util.Mp4BoxParsers.parseTREX(box.reader);
    ...
    parse(mediaSegment) {
      const Mp4Parser = shaka.util.Mp4Parser;
      const captionPackets: CaptionPacket[] = [];
      ...
      new Mp4Parser()
        ...
        .fullBox("tfhd", (box) => {
          ...
          defaultSampleDuration =
            parsedTFHD.defaultSampleDuration || this.defaultSampleDuration_;
          defaultSampleSize =
    ...
    private parseMdat_(
      ...
      while (reader.hasMoreData()) {
        ...
        if (sampleSize == 0) {
          ...
          if (sampleData.length > sampleIndex) {
            sampleSize =
              sampleData[sampleIndex].sampleSize || defaultSampleSize;
          } else {
