...
export class GapJumpingController implements IReleasable {
   ...
   */
  constructor(
      video: HTMLMediaElement, timeline: PresentationTimeline,
      config: shaka.extern.StreamingConfiguration, stallDetector: StallDetector,
  ...
  private onPollGapJump_() {
    ...
    const gapIndex = TimeRangesUtils.getGapIndex(
