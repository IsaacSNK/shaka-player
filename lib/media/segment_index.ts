...
namespace shaka.media {
   ...
   * @export
   */
  export class MetaSegmentIndex
    extends shaka.media.SegmentIndex
    implements IReleasable, Iterable<SegmentReference>
  {
    ...
    offset(offset) {
      ...
      goog.asserts.assert(
        false,
        "offset() should not be used in MetaSegmentIndex!"
      );
    }
    ...
    merge(references) {
      ...
      goog.asserts.assert(
        false,
        "merge() should not be used in MetaSegmentIndex!"
      );
    }
    ...
    evict(time) {
      ...
      goog.asserts.assert(
        false,
        "evict() should not be used in MetaSegmentIndex!"
      );
    }
    ...
    mergeAndEvict(references, windowStart) {
      ...
      goog.asserts.assert(
        false,
        "mergeAndEvict() should not be used in MetaSegmentIndex!"
      );
    }
    ...
    fit(windowStart, windowEnd) {
      ...
      goog.asserts.assert(
        false,
        "fit() should not be used in MetaSegmentIndex!"
      );
    }
    ...
    updateEvery(interval, updateCallback) {
      ...
      goog.asserts.assert(
        false,
        "updateEvery() should not be used in MetaSegmentIndex!"
      );
    }
  }
}
