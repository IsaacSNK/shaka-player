...
export class AdaptationSet {
   ...
   */
  constructor(
      root: shaka.extern.Variant, candidates?: Iterable<shaka.extern.Variant>) {
    this.root_ = root;
  ...
  static areAdaptable(a: shaka.extern.Variant, b: shaka.extern.Variant):
      boolean {
  ...
  private static areAudiosCompatible_(
      a: shaka.extern.Stream, b: shaka.extern.Stream): boolean {
    const AdaptationSet = AdaptationSet;
    ...
    if (!a.channelsCount || !b.channelsCount || a.channelsCount > 2 ||
        b.channelsCount > 2) {
   ...
   *
   */
  private static areRolesEqual_(a: Iterable<string>, b: Iterable<string>):
      boolean {
