...
export class InitSegmentReference {
  ...
  /**
     ...
     */ 
  constructor(uris: () => string[], public readonly startByte: number, public readonly endByte: number | null, mediaQuality: null | shaka.extern.MediaQualityInfo = null) {
    this.getUris = uris;
  ...
  /**
     ...
     */ 
  static equal(reference1: InitSegmentReference | null, reference2: InitSegmentReference | null): boolean {
    const ArrayUtils = ArrayUtils;
    if (!reference1 || !reference2) {
      return reference1 == reference2;
    } else {
      return reference1.getStartByte() == reference2.getStartByte() && reference1.getEndByte() == reference2.getEndByte() && ArrayUtils.equal(reference1.getUris(), reference2.getUris());
    }
  }
}
...
export class SegmentReference {
  ...
  /**
     ...
     */ 
  constructor(public startTime: number, public endTime: number, uris: () => string[], public readonly startByte: number, public readonly endByte: number | null, public initSegmentReference: InitSegmentReference, public timestampOffset: number, public appendWindowStart: number, public appendWindowEnd: number, public partialReferences: SegmentReference[] = [], public tilesLayout: string | null = '', public tileDuration: number | null = null, public syncTime: number | null = null, public status: Status = 
  Status.AVAILABLE, public hlsAes128Key: shaka.extern.HlsAes128Key | null = null) {
