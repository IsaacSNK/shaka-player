...
namespace shaka.media {
  ...
  export class InitSegmentReference {
    ...
    static equal(
      ...
      reference2: InitSegmentReference | null
    ): boolean {
...
namespace shaka.media {
  ...
  export class SegmentReference {
    ...
    constructor(
      ...
      public status: Status = shaka.media.SegmentReference.Status.AVAILABLE,
      ...
      goog.asserts.assert(
        endByte == null || startByte < endByte,
...
namespace shaka.media.SegmentReference {
  /**
