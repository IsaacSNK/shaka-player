 ...
 */ 
import{CeaDecoder}from './cea_decoder';
import*as CeaDecoderExports from './cea_decoder';
import{Mp4CeaParser}from './mp4_cea_parser';
...
export class IClosedCaptionParser {
  ...
  /**
     ...
     */ 
  parseFrom(mediaFragment: BufferSource): ICaptionDecoderExports.ClosedCaption[] {
  }
