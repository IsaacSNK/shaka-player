...
import*as RegionTimelineExports from './region_timeline';
...
export class RegionObserver extends FakeEventTarget implements IPlayheadObserver {
  ...
  constructor(timeline: RegionTimeline) {
    ...
    this.rules_ = [{weWere:null, weAre:IN_THE_REGION, invoke: 
    (region, seeking) => this.onEvent_('enter', region, seeking)}, {weWere:BEFORE_THE_REGION, weAre:IN_THE_REGION, invoke: 
    (region, seeking) => this.onEvent_('enter', region, seeking)}, {weWere:AFTER_THE_REGION, weAre:IN_THE_REGION, invoke: 
    (region, seeking) => this.onEvent_('enter', region, seeking)}, {weWere:IN_THE_REGION, weAre:BEFORE_THE_REGION, invoke: 
    (region, seeking) => this.onEvent_('exit', region, seeking)}, {weWere:IN_THE_REGION, weAre:AFTER_THE_REGION, invoke: 
    (region, seeking) => this.onEvent_('exit', region, seeking)}, {weWere:BEFORE_THE_REGION, weAre:AFTER_THE_REGION, invoke: 
    (region, seeking) => this.onEvent_('skip', region, seeking)}, {weWere:AFTER_THE_REGION, weAre:BEFORE_THE_REGION, invoke: 
    (region, seeking) => this.onEvent_('skip', region, seeking)}];
    this.eventManager_ = new EventManager();
    this.eventManager_.listen(this.timeline_, 'regionremove',  
    (event) => {
  ...
  /**
     ...
     *
     */ 
  private onEvent_(eventType: string, region: shaka.extern.TimelineRegionInfo, seeking: boolean) {
    const event = new FakeEvent(eventType, new Map([['region', region], ['seeking', seeking]]));
  ...
  /**
     ...
     *
     */ 
  private static determinePositionRelativeTo_(region: shaka.extern.TimelineRegionInfo, seconds: number): RelativePosition_ {
    const RelativePosition = RelativePosition_;
...
type Rule_ = {weWere:RelativePosition_ | null, weAre:RelativePosition_ | null, invoke:EventListener};
