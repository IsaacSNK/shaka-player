...
export class StallDetector implements IReleasable {
   ...
   */
  constructor(
      implementation: Implementation, stallThresholdSeconds: number,
...
export class MediaElementImplementation implements Implementation {
  ...
  shouldBeMakingProgress() {
    ...
    return MediaElementImplementation.hasContentFor_(
   ...
   *
   */
  private static hasContentFor_(buffered: TimeRanges, timeInSeconds: number):
      boolean {
