...
import {ManifestTextParser} from './dev-workspace.shaka-player-fork.lib.hls.manifest_text_parser';
import * as ManifestTextParserExports from './dev-workspace.shaka-player-fork.lib.hls.manifest_text_parser';
import {Playlist} from './dev-workspace.shaka-player-fork.lib.hls.hls_classes';
import {PlaylistType} from './dev-workspace.shaka-player-fork.lib.hls.hls_classes';
...
import {InitSegmentReference} from './dev-workspace.shaka-player-fork.lib.media.segment_reference';
...
import {DataUriPlugin} from './dev-workspace.shaka-player-fork.lib.net.data_uri_plugin';
...
import {Segment} from './dev-workspace.shaka-player-fork.lib.hls.hls_classes';
