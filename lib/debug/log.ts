...
if (window.console && window.console.log.bind) {
  ...
  [Level.ERROR]:console.error.bind(console), [Level.WARNING]:console.warn.bind(console), [Level.INFO]:console.info.bind(console), [Level.DEBUG]:console.log.bind(console), [Level.V1]:console.debug.bind(console), [Level.V2]:console.debug.bind(console)};
