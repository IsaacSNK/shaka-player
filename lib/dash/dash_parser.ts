...
import * as ContentProtectionExports from './dev-workspace.shaka-player-fork.lib.dash.content_protection';
import {ContentProtection} from './dev-workspace.shaka-player-fork.lib.dash.content_protection';
...
import * as SegmentListExports from './dev-workspace.shaka-player-fork.lib.dash.segment_list';
import {SegmentList} from './dev-workspace.shaka-player-fork.lib.dash.segment_list';
import * as SegmentTemplateExports from './dev-workspace.shaka-player-fork.lib.dash.segment_template';
import {SegmentTemplate} from './dev-workspace.shaka-player-fork.lib.dash.segment_template';
...
extern.ManifestParser {
  ...
  async update() {
    try {
      ...
      asserts.assert(error instanceof Error, 'Bad error type');
